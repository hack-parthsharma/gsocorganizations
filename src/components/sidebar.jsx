            ...
            <center>
                ...
                <tbody>
                  <tr>
                    <td>
                      <GitHubButton
                        data-size="large"
                        href="https://github.com/hack-parthsharma/gsocorganizations"
                        data-icon="octicon-star"
                        data-show-count="true"
                        aria-label="Star hack-parthsharma/gsoc-organizations-site on GitHub"
                      >
                        Star
                      </GitHubButton>
                    </td>
                    ...
                    <td>
                      <OutboundLink
                        href="https://www.twitter.com/hirensharmaji"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <Button
              ...
              <div className="sidebar-footer-text-container">
                <span className="sidebar-footer-text">
                  ...
                  by{" "}
                  <OutboundLink
                    href="https://www.github.com/hack-parthsharma"
